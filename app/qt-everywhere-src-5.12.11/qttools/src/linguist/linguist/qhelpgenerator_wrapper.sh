#!/bin/sh
LD_LIBRARY_PATH=/code/sdb/sanyusdk/app/qt-everywhere-src-5.12.11/qttools/lib:/code/sdb/sanyusdk/app/qt-everywhere-src-5.12.11/qtbase/lib${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}
...
exec /code/sdb/git/test/SanyuJoJo_board_qemu/app/qt-everywhere-src-5.12.11/qttools/bin/qhelpgenerator "$@"

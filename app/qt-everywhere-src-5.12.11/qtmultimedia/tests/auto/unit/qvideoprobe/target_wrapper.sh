#!/bin/sh
LD_LIBRARY_PATH=/code/sdb/sanyusdk/app/qt-everywhere-src-5.12.11/qtmultimedia/lib:/code/sdb/sanyusdk/app/qt-everywhere-src-5.12.11/qtbase/lib${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}

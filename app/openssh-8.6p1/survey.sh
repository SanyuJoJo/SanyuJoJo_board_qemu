...
CPPFLAGS="-I/code/sdb/sanyusdk/app/output/include  -D_XOPEN_SOURCE=600 -D_BSD_SOURCE -D_DEFAULT_SOURCE"
LDFLAGS="-L/code/sdb/sanyusdk/app/output/lib  -Wl,-z,relro -Wl,-z,now -Wl,-z,noexecstack -fstack-protector-strong -pie "
